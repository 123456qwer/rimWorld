...
class LogTableView: UITableView,UITableViewDelegate,UITableViewDataSource {
    ...
    override init(frame: CGRect, style: UITableView.Style) {
        ...
        self.register(UINib.init(nibName: "LogCell", bundle: nil), forCellReuseIdentifier: "LogCell")
