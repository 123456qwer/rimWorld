...
//            make.height.equalTo(labelHeight)
    ...
    @objc func chopAction(_ sender: UIButton) {
        ...
        /// 
        RMEventBus.shared.requestCuttingTask(entity: entity, canChop: sender.isSelected)
    }
