...
//            make.height.equalTo(labelHeight)
    ...
    func setData(_ entity:RMEntity) {
        ...
        guard let info = entity.getComponent(ofType: MiningComponent.self) else { return }
        
        name.text = info.miningTexture
        
        weakEntity = entity
        
        chopBtn.isSelected = EntityAbilityTool.ableToMarkMine(entity, ecsManager!)
    ...
    /// 点击挖掘
    @objc func mineAction(_ sender: UIButton) {
        ...
        ///
        RMEventBus.shared.requestMiningTask(entity: entity, canMine: sender.isSelected)
    }
    ...
    lazy var chopBtn:UIButton = {
        ...
        btn.addTarget(self, action: #selector(mineAction), for: .touchUpInside)
        return btn
    }()
